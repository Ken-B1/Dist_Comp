...
INSERT INTO `account` VALUES (1,1,'Belgium','admin@hotmail.com','admin','Male','admin','admin','admin',0),(2,0,'Belgium','user@hotmail.com','user','Female','user','user','user',0),(5,0,'','kenbauwens@hotmail.com','Ken','male','Bauwens','test','newaccount',0),(6,0,'belgium','test@hotmail.com','test','test','test','test','ff',0),(7,0,'ken','ken','ken','ken','ken','ken','ken',0),(8,0,'United States','d','dd','M','d','d','d',0);
...
INSERT INTO `messages` VALUES (0,1,1,'cc','cc',0,'2038-01-19 03:14:07'),(1,1,1,'dd','dd',0,'2038-01-19 03:14:07');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='This is a schema that will contain possible actions done by users (Like crudding boards and pins). Used for notifications and possible admin statistics';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `useractions` VALUES (1,1,1,'2018-05-08 16:10:35'),(2,1,1,'2018-05-08 16:11:47'),(3,4,1,'2018-05-09 19:59:17');
...
-- Dump completed on 2018-05-10 10:52:55
