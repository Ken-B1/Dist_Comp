...
INSERT INTO `account` VALUES (1,1,'Belgium','admin@hotmail.com','admin','Male','admin','admin','admin',0,NULL),(2,0,'Belgium','user@hotmail.com','user','Female','user','user','user',0,NULL),(3,0,'United States','user2@gmail.com','user2','M','user2','user2','user2',0,NULL),(4,0,'United States','s','s','M','s','s','s0143225',0,NULL),(5,0,'Taiwan (å°ç£)','test2','test','M','test','test','test',0,NULL),(6,1,'United States','u','u','M','u','u','u',0,NULL);
...
INSERT INTO `accountcategoryjunction` VALUES (1,1),(2,1),(5,1),(3,2),(4,2),(5,2),(2,6),(3,6),(4,6);
...
INSERT INTO `board` VALUES (1,'newName',1,1,1),(2,'adminBoard2',2,1,0),(13,'newBoard',3,1,0),(14,'test',2,1,0),(15,'userShouldSeeThis',3,1,0),(16,'userShouldSeeThis2',4,1,0),(22,'userShouldSeeThis4',3,1,0),(23,'YetAnotherNotificationForBoard',4,1,0),(24,'testt',5,1,0),(25,'r',2,1,0),(26,'r',3,1,0),(27,'r',2,1,0),(29,'remoteTest',3,1,0),(30,'ffdfdsfadfadfdsf',2,1,0),(31,'fda',2,1,0),(32,'asdf',3,1,0),(33,'fffffff',2,1,0),(34,'fdf',3,6,0),(35,'nameUpdate',2,1,0),(36,'test',2,1,0),(37,'test',2,1,0),(38,'test',2,1,0),(39,'test',2,1,0),(40,'test',2,1,0),(41,'test',2,1,0),(42,'test',2,1,0),(43,'test',2,1,0),(44,'test',2,1,0),(45,'test',2,1,0);
...
INSERT INTO `categories` VALUES (1,NULL,'African'),(2,NULL,'Belgian'),(3,NULL,'French'),(4,NULL,'Indian'),(5,NULL,'Spanish'),(6,NULL,'testCategory'),(7,NULL,'newCategory'),(8,NULL,'uu');
...
INSERT INTO `messages` VALUES (1,1,2,'hELLO','World',0,'2018-05-10 10:00:00'),(2,2,1,'ss','dd',1,'2018-05-10 10:00:00'),(3,1,1,'World','Hello',1,'2018-05-11 15:32:01'),(4,1,1,'World','Hello',1,'2018-05-11 15:45:50'),(5,1,2,'Earth','Hi',1,'2018-05-11 15:51:09'),(6,2,1,'Terestrial','Hey',1,'2018-05-11 15:51:31'),(7,1,2,'hello','hi',0,'2018-05-11 18:36:46'),(8,1,2,'fff','dd',0,'2018-05-12 14:11:24'),(9,1,2,'ff','ff',1,'2018-05-13 23:31:24'),(10,1,2,'uuuuuu','uuuuuu',0,'2018-05-15 15:46:22'),(11,1,2,'fd','fd',0,'2018-05-16 20:01:13'),(12,1,1,'eeeee','eeeee',0,'2018-05-16 20:01:19'),(13,1,1,'eeeee','eeeee',0,'2018-05-16 20:01:23');
...
INSERT INTO `notifications` VALUES (1,2,1,3,1,NULL),(2,1,2,1,1,'22'),(3,1,2,1,1,'23'),(4,1,1,2,1,'12'),(5,1,1,2,0,'13'),(6,1,2,2,1,'14'),(7,1,2,1,0,'24'),(8,1,2,1,0,'25'),(9,1,2,1,0,'26'),(10,1,2,1,0,'27'),(11,1,2,2,0,'15'),(12,1,2,2,0,'16'),(13,1,2,2,0,'17'),(14,1,2,2,0,'18'),(15,1,2,2,0,'20'),(16,1,2,2,0,'22');
...
CREATE TABLE `peoplefollower` (
  ...
  CONSTRAINT `FK_Userid_Followers` FOREIGN KEY (`userId`) REFERENCES `account` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_peoplefollower_FollowedUser` FOREIGN KEY (`FollowedUser`) REFERENCES `account` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pin` VALUES (10,'d','d',1,'C:\\Users\\ken\\p4foodPictures\\O5J9RtKLtYZ68v5JXVeCRYg1tkpXZhL9CHyg8v1kpfs.jpg'),(11,'rec','rec',2,'C:\\Users\\ken\\p4foodPictures\\0qkaVYr.jpg'),(12,'ddd','NewPinForUser',23,'C:\\Users\\ken\\p4foodPictures\\laUneyx.png'),(13,'ff','NewPinForUser2',23,'C:\\Users\\ken\\p4foodPictures\\IMG_20170912_144630.jpg'),(14,'fff','NewPinForUser3',23,'C:\\Users\\ken\\p4foodPictures\\IMG_20170912_145041.jpg'),(15,'fff','recipeWithImage',1,'C:\\Users\\ken\\p4foodPictures\\IMG_20170901_082454.jpg'),(16,'rrr','remoteTest',1,'C:\\Users\\ken\\p4foodPictures\\K8XK4at.jpg'),(17,'a','a',1,'C:\\Users\\ken\\p4foodPictures\\devil may crry 4 - 2 - esrb t pegi 12+.jps'),(18,'b','b',1,'C:\\Users\\ken\\p4foodPictures\\guitar hero 3 - 2 - esrb t pegi 12+.jps'),(20,'fda','fdas',1,'sOeue01.jpg'),(21,'ds','ds',34,'0qkaVYr.jpg'),(22,'ffff','ffff',1,'0qkaVYr.jpg');
...
CREATE TABLE `useractions` (
  ...
  KEY `FK_Useractions_User_idx` (`userId`),
  ...
  CONSTRAINT `FK_Useractions_User` FOREIGN KEY (`userId`) REFERENCES `account` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2018-05-19 11:31:07
