...
INSERT INTO `account` VALUES (1,1,'Belgium','admin@hotmail.com','admin','Male','admin','admin','admin',0),(2,0,'Belgium','user@hotmail.com','user','Female','user','user','user',0);
...
INSERT INTO `board` VALUES (1,'adminBoard',1,1,0),(2,'adminBoard2',2,1,0),(13,'newBoard',3,1,0);
...
INSERT INTO `messages` VALUES (1,1,2,'hELLO','World',0,'2018-05-10 10:00:00'),(2,2,1,'ss','dd',1,'2018-05-10 10:00:00'),(3,1,1,'World','Hello',1,'2018-05-11 15:32:01'),(4,1,1,'World','Hello',1,'2018-05-11 15:45:50'),(5,1,2,'Earth','Hi',1,'2018-05-11 15:51:09'),(6,2,1,'Terestrial','Hey',1,'2018-05-11 15:51:31'),(7,1,2,'hello','hi',0,'2018-05-11 18:36:46');
...
INSERT INTO `pin` VALUES (1,'recipe','recipeName',1),(2,'recipe','recipeName',2),(3,'recipe2','recipeName2',1),(4,'recipe3','recipeName3',1),(5,'testpin','rrr',1),(6,'f','f',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='This is a schema that will contain possible actions done by users (Like crudding boards and pins). Used for notifications and possible admin statistics';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `useractions` VALUES (1,1,1,'2018-05-08 16:10:35'),(2,1,1,'2018-05-08 16:11:47'),(3,4,1,'2018-05-09 19:59:17'),(4,1,1,'2018-05-10 11:31:41'),(5,1,1,'2018-05-11 17:30:04'),(6,1,1,'2018-05-11 17:37:05'),(7,2,1,'2018-05-11 19:06:13'),(8,2,1,'2018-05-11 19:07:54'),(9,2,1,'2018-05-11 19:08:45'),(10,1,1,'2018-05-11 19:18:14');
...
-- Dump completed on 2018-05-11 19:26:51
